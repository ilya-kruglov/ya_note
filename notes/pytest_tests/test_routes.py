...
# Параметризованный тест, в котором объединены все адреса,
...
# Доступность страницы со списком заметок, страницы добавления новой записи
# и страницы успешного добавления записей
@pytest.mark.parametrize(
    'name',
...
# Страница с заметкой, страница редактирования
# и страница удаления заметки доступны её автору (200)
# и НЕдоступны НЕ автору заметки (404)
